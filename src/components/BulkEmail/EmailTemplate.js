        ...
        <body>
            <style>
                * { box-sizing: border-box; }
                ...
                table { width: 100%; border-collapse: collapse; margin-top: 10px; margin-bottom: 30px; font-size: 14px; page-break-inside: avoid; }
                tr { page-break-inside: avoid; page-break-after: auto; }
                th, td { text-align: left; padding: 12px; border-bottom: 1px solid #f1f5f9; page-break-inside: avoid; }
                ...
                .footer { padding: 30px; text-align: center; font-size: 12px; color: #94a3b8; border-top: 1px solid #f1f5f9; page-break-inside: avoid; }
                ...
                <div class="content">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td>Basic Salary</td>
                                <td class="amount">${fmt(staff['BASIC SALARY (CURRENT)'])}</td>
                                <td class="amount">${fmt(staff['BASIC SALARY (ARREARS)'])}</td>
                                <td class="amount fw-bold">${fmt(staff['BASIC SALARY (TOTAL AMOUNT)'])}</td>
                            </tr>
                            <tr>
                                <td>Housing Allowance</td>
                                <td class="amount">${fmt(staff['HOUSING ALLOWANCE (CURRENT)'])}</td>
                                <td class="amount">${fmt(staff['HOUSING ALLOWANCE (ARREARS)'])}</td>
                                <td class="amount fw-bold">${fmt(staff['HOUSING ALLOWANCE (TOTAL AMOUNT)'])}</td>
                            </tr>
                            <tr>
                                <td>Transport Allowance</td>
                                <td class="amount">${fmt(staff['TRANSPORT ALLOWANCE (CURRENT)'])}</td>
                                <td class="amount">${fmt(staff['TRANSPORT ALLOWANCE (ARREARS)'])}</td>
                                <td class="amount fw-bold">${fmt(staff['TRANSPORT ALLOWANCE (TOTAL AMOUNT)'])}</td>
                            </tr>
                            <tr class="total-row">
                                <td>Gross Pay</td>
                                <td class="amount"></td>
                                <td class="amount"></td>
                                <td class="amount text-emerald">${fmt(staff['Gross Pay'])}</td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="amount"></td>
                                <td class="amount"></td>
                                <td class="amount fw-bold">${fmt(staff['PENSION'])}</td>
                            </tr>
                            <tr>
                                <td>PAYE Tax</td>
                                <td class="amount"></td>
                                <td class="amount"></td>
                                <td class="amount fw-bold">${fmt(staff['PAYE -TAX'])}</td>
                            </tr>
                            <tr>
                                <td>Other Deductions</td>
                                <td class="amount"></td>
                                <td class="amount"></td>
                                <td class="amount fw-bold">${fmt(staff['OTHER DEDUCTIONS'])}</td>
                            </tr>
                            <tr class="total-row">
                                <td>Total Deductions</td>
                                <td class="amount"></td>
                                <td class="amount"></td>
                                <td class="amount text-danger">${fmt(staff['Total Deductions'])}</td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr class="total-row">
                                <td>Net Payable</td>
                                <td class="amount text-emerald" style="font-size: 18px;">₦${fmt(staff['NET PAY'] || '0')}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div style="max-width: 600px; margin: 40px auto; background: white; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1);">
                ...
                <div style="padding: 40px;">
                    ...
                    <div style="background: #f1f5f9; border-radius: 8px; padding: 20px; text-align: center; margin: 25px 0;">
                        ...
                        <div style="font-size: 28px; font-weight: 800; color: #10b981;">₦${fmt(staff['NET PAY'] || '0')}</div>
                    </div>
